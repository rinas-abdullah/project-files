...
async function seed() {
  ...
  await db.insert(patients).values([
    ...
    },
    {
      ...
      diagnosis: "اعتلال توازن بعد جلطة دماغية خفيفة",
    ...
    },
    {
      ...
      diagnosis: "مرض باركنسون - المرحلة الثانية",
      consultant: "د. خلود المطيري",
    ...
    },
    {
      ...
      age: 71,
      status: "critical",
      statusLabel: "حرج — خطر سقوط مرتفع",
      complianceScore: 74,
      careType: "رعاية مكثفة عن بعد",
      diagnosis: "تصلب لويحي نشط - عدم اتزان حاد",
      consultant: "د. خالد السليمان",
  ...
  await db.insert(medicalNotes).values([
    {
      ...
      date: "2025-05-12",
      content: "المريضة تظهر استجابة ممتازة لتوزيع الحمل عبر اللباد الطبي الذكي. تحسّن التوازن الحركي بنسبة 85% مقارنة بخط الأساس.",
    },
    {
      id: "n2",
      patientId: "pat-2",
  ...
  await db.insert(users).values([
    {
      ...
      role: "doctor",
      email: "dr.khalid@ditharhealth.sa",
      passwordHash: bcrypt.hashSync(DOCTOR_PASSWORD, 10),
      department: "استشاري طب إعادة التأهيل العصبي والحركي",
    ...
    },
    {
      ...
      name: "سارة بنت أحمد العتيبي",
      role: "patient",
      email: "sara.alotaibi@ditharhealth.sa",
