...
export default function Roadmap() {
  const milestones = [
    ...
    },
    {
      ...
      desc: "البدء في دراسات سريرية موثقة بالتعاون مع مراكز التأهيل العصبي والحركي والمستشفيات الجامعية الكبرى للتحقق من كفاءة التنبؤ الذكي.",
    },
    {
      year: "2028",
    ...
    },
    {
      ...
      desc: "توقيع شراكات استراتيجية مع شركات التأمين الكبرى والتوسع في الأسواق الإقليمية والخليجية لدعم كبار السن ومرضى الجلطات الدماغية وباركنسون.",
    },
    {
      year: "2030",
