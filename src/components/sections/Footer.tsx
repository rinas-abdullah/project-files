            ...
            >
              ...
              <div className="text-white/70 text-sm leading-relaxed font-arabic font-light space-y-4 max-h-[60vh] overflow-y-auto pr-2 custom-scrollbar">
                ...
                <div className="space-y-2">
                  ...
                  <p>تُستخدم البيانات الحيوية حصرياً لتمكين محرك الذكاء الاصطناعي من تحليل حركة المريض وتوفير تنبؤات مبكرة للمخاطر السريرية (مثل مخاطر السقوط وتراجع التوازن بعد الجلطات الدماغية) ومشاركتها مع طبيبك المعالج فقط لدعم اتخاذ القرار الطبي.</p>
                </div>
