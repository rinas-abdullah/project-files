    ...
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-risaq-muted text-sm mt-1">منصة التدريب السيبراني الذكي</p>
        </div>

        <div className="card p-8">
          <h2 className="text-lg font-bold mb-1">تسجيل الدخول</h2>
          <p className="text-sm text-risaq-muted mb-6">أدخل بياناتك للمتابعة إلى مختبراتك</p>
        ...
        <p className="text-center text-sm text-risaq-muted mt-6">
          ليس لديك حساب؟{" "}
          <Link to="/register" className="text-risaq-primary font-bold hover:underline">
            أنشئ حساباً جديداً
          </Link>
        </p>
      </div>
